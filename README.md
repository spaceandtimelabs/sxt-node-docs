...
1. Due to P2P traffic considerations (more on this in section 2.3), Each AKS cluster can only host a single instance of SXT validator. Other node types may be able to share the same cluster.
